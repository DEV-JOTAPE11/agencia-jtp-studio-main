      ...
      >
        ...
        <div className="flex items-center justify-center gap-3 mb-8 flex-wrap">
          <div
            ...
            style={{
              background:
                "color-mix(in oklab, lab(76.3898% 14.5258 98.4589) 10%, transparent)",
              border: "1px solid lab(83.2664% 8.65132 106.895 / 0.25)",
            }}
          >
            <div className="flex items-center gap-0.5">
              {Array.from({ length: 5 }).map((_, i) => (
                <Star
                  ...
                  className="h-3 w-3"
                  style={{
                    fill: "lab(76.3898% 14.5258 98.4589)" /* Cor interna (Yellow 500) */,
                    color:
                      "lab(76.3898% 14.5258 98.4589)" /* Cor da borda (Yellow 500) */,
                  }}
                />
              ))}
            </div>
          ...
          <div
            ...
            style={{
              ...
              border: "1px solid rgba(40,126,215,0.25)",
            }}
          >
        ...
        <p className="mt-6 text-lg text-muted-foreground max-w-xl mx-auto">
          Agência especializada em criação de sites profissionais, landing pages
          e lojas virtuais que geram resultados reais.
        </p>
